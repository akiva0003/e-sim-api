...
def congressElections(https, server):
    ...
    candidates = tree.xpath("//tr//td[2]//a/text()") or ["-"]
    candidates_links = [int(x.split("id=")[1]) for x in tree.xpath("//tr//td[2]//a/@href")] or [0]
    parties = tree.xpath("//tr//td[4]//div/a/text()") or ["-"]
    parties_links = [int(x.split("id=")[1]) for x in tree.xpath("//tr//td[4]//div/a/@href")] or [0]
